...
- Dos archivos ejecutables (CompilarLinux.sh y CompilarWindows.bat) con el comando de compilacion utilizado.
El mismo es "gcc -std=c99 -Wall -Werror -o ejectuable main.c map.c lista.c manejo_archivos.c filter.c".
